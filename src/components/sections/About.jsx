  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 hover:-translate-y-1 transition">
      <div className="flex items-center gap-2 mb-4">
        <HiOutlineInformationCircle size={25} className="text-gray-700 dark:text-gray-300" />
        <h2 className="font-bold text-2xl text-gray-900 dark:text-white">About me.</h2>
      </div>
